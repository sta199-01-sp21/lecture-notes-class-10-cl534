...
The probability is 51.2%.

- What is the probability a randomly selected patient received the placebo
  and had a marked improvement?
  
  The probability is 8.3%
  
- What is the probability a randomly selected patient received the placebo
  and the treatment?
  
  Disjoint probability: two events not possible at the same time. The probability is 0%.
  
- What is the probability a randomly selected patient had some improvement or
  was on the treatment?
  
  The probability is 57.1%
...
roll_results <- roll_results %>%
  mutate(event_1 = die_1 ^ 2 == die_2, event_2 = abs(die_1 - die_2) == 4)
roll_results
```
